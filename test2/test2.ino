  ...
  void rof(const int columns[], const int rows[]) {
    int length = sizeof(columns) / sizeof(columns[0]);
    ...
    for (int i = 0; i < length; i++) {
        ...
        if (i < length - 1) {
            ...
            if (nextYsteps > 0) {
                ...
                ydown(nextYsteps); // استخدمت ydown مع تصحيح اتجاه الخطوات
            }
            ...
            if (nextXsteps > 0) {
                ...
                xright(nextXsteps); // استخدمت xright مع تصحيح اتجاه الخطوات
            }
